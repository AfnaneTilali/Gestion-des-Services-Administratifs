...
<body>
	...
	<div id="right-panel" class="right-panel">
				...
				<div class="page-header float-right">
					<div class="page-title">
						<ol class="breadcrumb text-right">
							...
							<li class="active">Declarer un Probleme</li>
						</ol>
					</div>
				</div>
			</div>
		...
		<section class="site-section" id="next-section">
			<div class="container">
				<div class="row">
					<div class="col-lg-6 mb-5 mb-lg-0" style="margin-left: 2em;">
						<form action="DeclarerProb.php" method="post" class="">
<br>
		<h3
			style="font-family: algerian, 'times new roman'; font-size: 30; text-align : left;">Contact
			Us</h3></br>
						...
						<!-- 	<div class="row form-group">
							...
							<div class="row form-group">
								...
								<div class="col-md-12">
									<label class="text-black" for="emailto">Email To</label> <select
										class="form-control" name="emailto">
					...
					<!-- 	<div class="row form-group">
								<div class="col-md-12">
									<label class="text-black" for="password">Your Password</label>
							...
							<div class="row form-group">
								<div class="col-md-12">
									<label class="text-black" for="subject">Subject</label> <input
										type="subject" name="subject" id="subject"
										class="form-control">
								</div>
							</div>
                    ...
                    <br><br><br><br><br><br><br>
						<div class="p-4 mb-3 bg">
							...
							<p class="mb-4">
								La présidence de l'umi ,Meknes 50000 <br> Mon - Fri: 8:30 -
								18:45
							</p>
