				...
				<div class="page-header float-right">
					<div class="page-title">
						<ol class="breadcrumb text-right">
							...
							<li class="active">Ajouter Etudiant</li>
						</ol>
					</div>
				</div>
			</div>
		</div>
		<form method="POST" action="AddE.php" enctype="multipart/form-data">
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<strong class="card-title">Ajouter un etudiant</strong>
								</div>
								<div class="card-body">
									<div class="card-body card-block">
										...
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input class="form-control" type="date" name="DateN"
										...
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input class="form-control" type="date" name="DateIns"
										...
										<div class="form-group">
											<div class="input-group">
												...
												<input class="form-control" type="text" name="VilleN"
													placeholder="Ville de naissance" required>
											</div>
										...
										<div class="form-group">
											<div class="input-group">
												...
												<select class="form-control" name="Sexe" required>
													<option value="" selected hidden>Sexe</option>
													<option>Femme</option>
													<option>Homme</option>
										...
										<div class="form-group">
											<div class="input-group">
												...
												<select class="form-control" name="Semestre" required>
													<option value="" selected hidden>Semestre</option>
											...
											<small class="form-text text-muted">ex. S4</small>
										</div>
										<div class="form-group">
											...
											<div class="fileupload fileupload-new"
												...
												<span class="btn btn-theme02 btn-file"> <span
													class="fileupload-new"><i class="fa fa-paperclip"></i>
														...
														class="fa fa-undo"></i> Change</span> <input type="file"
													class="default" name="file" required />
				...
				<div class="animated fadeIn">
					<div class="row">
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<strong class="card-title">Ajouter un parent</strong>
								</div>
								<div class="card-body">
									<div class="card-body card-block">
										<div class="form-group">
										...
										<div class="form-group">
											<div class="input-group">
												...
												<input class="form-control" type="text" name="CNIP"
													placeholder="CNI" required>
											</div>
											<small class="form-text text-muted">ex. D123456</small>
										</div>
										<div class="form-group">
											<div class="input-group">
												...
												<input class="form-control" type="email" name="EmailP"
													placeholder="Email" required>
											</div>
											<small class="form-text text-muted">ex. abc@xy.z</small>
										</div>
