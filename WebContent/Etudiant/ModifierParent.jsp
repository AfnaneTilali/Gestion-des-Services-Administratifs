...
<body>
	...
	<div id="right-panel" class="right-panel">
		...
		<form method="POST" action="updatePE.php">
										...
										<div class="form-group">
											<div class="input-group">
												...
												<input class="form-control" type="text" name="NomP"
													value="${Mparent.getParent().getNomP()}" required>
											</div>
										...
										<div class="form-group">
											<div class="input-group">
												...
												<input class="form-control" type="text" name="PrenomP"
													value="${Mparent.getParent().getPrenomP()}" required>
											</div>
										...
										<div class="form-group">
											<div class="input-group">
												...
												<input class="form-control" type="number" name="Phone"
													value="${Mparent.getParent().getPhone()}" required>
											</div>
										...
										<div class="form-group">
											<div class="input-group">
												...
												<input class="form-control" type="text" name="CNIP"
													value="${Mparent.getParent().getCniP()}" desabled>
											</div>
										...
										<div class="form-group">
											<div class="input-group">
												...
												<input class="form-control" type="email" name="EmailP"
													value="${Mparent.getParent().getEmailP()}" required>
											</div>
