			...
			<div class="col-sm-4">
				<div class="page-header float-left">
					<div class="page-title">
						<h1>Consultation des Information </h1>
					</div>
				</div>
			</div>
			<div class="col-sm-8">
				<div class="page-header float-right">
					<div class="page-title">
						<ol class="breadcrumb text-right">
							...
							<li><a href="RechercheEtudiantE.php">Recherche de
									nouveau</a></li>
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-header">
								<strong class="card-title">Erreur</strong>
							</div>
							<br>
							<div class="col-sm-12">
								<div class="alert  alert-danger alert-dismissible fade show"
									...
									<span class="badge badge-pill badge-danger"
										style="margin-left: 28em;">Success</span>Le Cni de ce Etudiant
									n'existe pas.
							...
							<div class="card-body">
								<div class="card-body card-block">
									<a href="InscriptionE.php" type="button"
										class="btn btn-outline-success btn-lg btn-block">Inscription
									</a> <a href="RechercheEtudiantE.php" type="button"
										class="btn btn-outline-info btn-lg btn-block">Recherche de
										nouveau</a> <a href="HomeE.php" type="button"
										class="btn btn-outline-secondary btn-lg btn-block">Menu</a>
								</div>
							</div>
							<!-- .animated -->
						</div>
