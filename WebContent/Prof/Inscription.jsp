...
<body>
	...
	<!-- Left Panel -->
		...
		<nav class="navbar navbar-expand-sm navbar-default">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="HomePr.php"><img
					src="images/logo.png" alt="Logo"></a> <a
					class="navbar-brand hidden" href="HomePr.php"><img
			...
			<div id="main-menu" class="main-menu collapse navbar-collapse">
				<ul class="nav navbar-nav">
					<div>
						<li class="active"><a href="HomePr.php"> <i
								class="menu-icon fa ti-home"></i>Home page
                        </a></li>
                        <li class="active"><a href="InscriptionPr.php"> <i
					...
					<li class="menu-item-has-children dropdown"><a href="#"
						...
						<ul class="sub-menu children dropdown-menu">
							<li><i class="fa fa-plus-square-o"></i><a href="">D'une
									classe</a></li>
							<li><i class="fa ti-search"></i><a href="">D'un Etudiant</a></li>
							<li><i class="fa ti-list-ol"></i><a href="">List All Abs</a></li>
						</ul></li>
					<li class="menu-item-has-children dropdown"><a href="#"
						class="dropdown-toggle" data-toggle="dropdown"
						aria-haspopup="true" aria-expanded="false"> <i
						...
						<ul class="sub-menu children dropdown-menu">
							<li><i class="fa fa-plus-square-o"></i><a href="">Ajout</a></li>
							<li><i class="fa ti-search"></i><a href="">Recherche</a></li>
							<li><i class="fa ti-list-ol"></i><a href="">List</a></li>
						</ul></li>
                        <li class="menu-item-has-children dropdown"><a href="#"
                            class="dropdown-toggle" data-toggle="dropdown"
                            aria-haspopup="true" aria-expanded="false"> <i
                                class="menu-icon fa fa-users"></i>Des Notes
                        </a>
                            <ul class="sub-menu children dropdown-menu">
	...
	<div id="right-panel" class="right-panel">
		...
		<form method="POST" action="AddPr.php">
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-header">
								<strong class="card-title">Ajout Prof</strong>
							</div>
							<div class="card-body">
								<div class="card-body card-block">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" type="text" name = "NomPr" placeholder="Nom"
											required>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" type="text" name = "PrenomPr" placeholder="Prenom"
											required>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <span class="symbol-input100"> <i class="fa fa-phone"></i></div>
                                            <input class="form-control" type="number" name = "PhonePr" placeholder="Phone"
											required>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" type="text" name = "CNIPr" placeholder="CNI" required>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" type="email" name = "EmailPr" placeholder="Email" required>
                                        </div>
