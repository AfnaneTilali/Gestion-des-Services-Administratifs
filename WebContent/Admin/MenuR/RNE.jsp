							...
							<div class="col-sm-12">
								<div class="alert  alert-danger alert-dismissible fade show"
									...
									<span class="badge badge-pill badge-danger"
										style="margin-left: 28em;">Success</span> Ce Etudiant n'existe
									pas.
							...
							<div class="card-body">
								<div class="card-body card-block">
									<a href="AjouterEtudiant.php" type="button"
										class="btn btn-outline-success btn-lg btn-block">Ajouter
										Etudiant</a> <a href="RechercheEtudiant.php" type="button"
										class="btn btn-outline-info btn-lg btn-block">Recherche de
										nouveau</a> <a href="HomeA.php" type="button"
