							...
							<div class="col-md-12">
								<div class="card">
									<div class="card-header">
										<strong class="card-title">Info Absence</strong>
									</div>
									<div class="card-body">
										<div class="card-body card-block">
											<div class="form-group">
												<label style="margin-left: 25em;">Date Absence</label>
												<div class="input-group">
													<div class="input-group-addon">
														<i class="fa ti-calendar"></i>
													</div>
													<input class="form-control"
														value="${Mabs.getAbs().getDateAbs()}" disabled>
												</div>
											</div>
											<div class="form-group">
												<label style="margin-left: 25em;">Nom Module</label>
												<div class="input-group">
													<div class="input-group-addon">
														<i class="fa ti-view-list"></i>
													</div>
													<input class="form-control"
														value="${Mabs.getAbs().getNomM()}" disabled>
												</div>
											</div>

											<div class="form-group">
												<label style="margin-left: 25em;">Cni Prof</label>
												<div class="input-group">
													<div class="input-group-addon">
														<i class="fa fa-asterisk"></i>
													</div>
													<input class="form-control"
														value="${Mabs.getAbs().getCniPr()}" disabled>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="input-group">
													...
													<input class="form-control"
														value="${Mabs.getAbs().getCniE()}" disabled>
												</div>
											</div>

											<div class="form-group">
												<label style="margin-left: 12em;">08:30-10:30</label> <label
													style="margin-left: 20em;">10:45-12:45</label>
												<div class="input-group">
													<div class="input-group-addon">
														<i class="fa ti-timer"></i>
													</div>
													<input class="form-control"
														value="${Mabs.getAbs().isCren1()}" disabled> <input
														class="form-control" value="${Mabs.getAbs().isCren2()}"
														disabled>
													<div class="input-group-addon">
														<i class="fa ti-timer"></i>
													</div>
											...
											<div class="form-group">
												<label style="margin-left: 12em;">14:30-16:30</label> <label
													style="margin-left: 20em;">16:45-18:45</label>
												<div class="input-group">
													<div class="input-group-addon">
														<i class="fa ti-timer"></i>
													</div>
													<input class="form-control"
														value="${Mabs.getAbs().isCren3()}" disabled> <input
														class="form-control" value="${Mabs.getAbs().isCren4()}"
														disabled>
													<div class="input-group-addon">
														<i class="fa ti-timer"></i>
													</div>
												...
												<br>
												<div>
													<a href="ModifierAbs.php?IdAbs=${Mabs.getAbs().getIdAbs()}"
														type="submit" class="btn btn-success btn-sm"> <i
														class="fa ti-marker-alt"></i> Modifier
													</a> <a
														href="supprimerAbsList.php?IdAbs=${Mabs.getAbs().getIdAbs()}"
