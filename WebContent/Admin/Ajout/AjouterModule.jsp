						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<strong class="card-title">Ajouter une Module</strong>
								</div>
								<div class="card-body">
									<div class="card-body card-block">
										<div class="form-group">
											...
											<small class="form-text text-muted">ex. Java 1</small>
										</div>
										<div class="form-group">
											<div class="input-group">
												<div class="input-group-addon">
										...
										<div class="form-group">
											<div class="input-group">
												...
												<select class="form-control" name="NomPr" required>
										...
										<div class="form-group">
											<div class="input-group">
												...
												<input class="form-control" type="number" name="NumS"
													placeholder="Num de Semestre" required>
											</div>
										...
										<div class="form-group">
											<div class="input-group">
												...
												<input class="form-control" type="number" name="Seuille"
													placeholder="Seuille" required>
											</div>
