	...
	<div id="right-panel" class="right-panel">
		...
		<div class="breadcrumbs">
 		...
 		<div class="content mt-3"> 
					<form method="POST" action="AddEquipement.php">
			<div class="animated fadeIn">
				<div class="row">
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<strong class="card-title">Ajouter un Equipement</strong>
								</div>
								<div class="card-body">
									<div class="card-body card-block">
										<div class="form-group">
											<div class="input-group">
												...
												<input class="form-control" type="text" name="NomEq"
													placeholder="Nom Equipement" required>
											</div>
											<small class="form-text text-muted">ex. pc</small>
										</div>
										<div class="form-group">
											<div class="input-group">
												<div class="input-group-addon">
												...
												<input class="form-control" type="number" name="NumEq"
													placeholder="Num de l'equipement" required>
											</div>
										...
										<div class="form-group">
											<div class="input-group">
												...
												<select class="form-control" name="NumS" required>
													<option value="" selected hidden>Num Salle</option>
													<c:forEach items="${Mother.getListSalle()}" var="salle">
														<option>${salle.getNumS()}</option>
													</c:forEach>
												</select> <span class="select-arrow"></span>
											</div>
											<small class="form-text text-muted">ex. 6
												</small>
										</div>
