	...
	<div id="right-panel" class="right-panel">
		...
		<div class="breadcrumbs">
 		...
 		<div class="content mt-3"> 
					<form method="POST" action="addF.php">
			<div class="animated fadeIn">
				<div class="row">
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<strong class="card-title">Ajouter une Filiere</strong>
								</div>
								<div class="card-body">
									<div class="card-body card-block">
										<div class="form-group">
											<div class="input-group">
												...
												<input class="form-control" type="text" name="NomF"
													placeholder="Nom Filiere" required>
											</div>
										...
										<div class="form-group">
											<div class="input-group">
												...
												<input class="form-control" type="text" name="Chef"
													placeholder="Chef" required>
											</div>
											<small class="form-text text-muted">ex. Einstein
												Albert</small>
										</div>
										...
										<div class="form-group">
											<div class="input-group">
												...
												<input class="form-control" type="number" name="NbrModule"
													placeholder="Nombre des Modules dans la Filiere" required>
											</div>
											<small class="form-text text-muted">ex. 50</small>
										</div>
										<div class="form-group">
											<div class="input-group">
												<div class="input-group-addon">
												...
												<input class="form-control" type="number" name="NbrSemestre"
													placeholder="Nombre des Semestre dans la Filiere" required>
											</div>
											<small class="form-text text-muted">ex. 6</small>
										</div>
										<div>
