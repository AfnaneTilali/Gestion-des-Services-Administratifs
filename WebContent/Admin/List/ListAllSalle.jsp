					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-header">
								<strong class="card-title">All Salles</strong>
							</div>
							<div class="card-body">
								<div class="row" style="margin-left: 26em;">
									<div class="col-sm-12 col-md-6">
										<div class="dataTables_length">
											<a href="AjouterSalle.php" type="button"
								...
								<table id="bootstrap-data-table-export"
									...
									<tbody>
										<c:forEach items="${Mother.getListSalle()}" var="salle">
											...
											<tr>
												<td>${salle.getNumS()}</td>
												<td>${salle.getEtageS()}</td>

												<td><a href="modifSalleList.php?NumS=${salle.getNumS()}">
												...
												<td><a
													href="supprimerSalleList.php?NumS=${salle.getNumS()}">
