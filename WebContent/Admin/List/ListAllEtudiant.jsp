				...
				<div class="page-header float-right">
					<div class="page-title">
						<ol class="breadcrumb text-right">
							<li><a href="HomeA">Home page</a></li>
								...
								<div class="row" style="margin-left: 20em;">
									<div class="col-sm-12 col-md-6">
										<div class="dataTables_length">
											<a href="AjouterEtudiant.php" type="button"
												class="btn btn-outline-success btn-sm"><i
												class="fa fa-plus-square-o"></i>&nbsp; Ajouter</a>
										</div>
									</div>
									<div class="col-sm-12 col-md-6">
										<div class="dataTables_length">
											<a href=".php" type="button"
												class="btn btn-outline-danger btn-sm"><i
												class="fa  fa-cloud-download"></i>&nbsp; Telecharger la
												liste</a>
										</div>
									</div>
								</div>
									...
									<tbody>
										<c:forEach items="${MEtudiant.listEtud}" var="e">
											<tr>
												...
												<td>${e.getVilleN()}</td>
												<td>${e.getCountry()}</td>
												<td>${e.getAnneeUniv()}</td>
												<td>${e.getSexe()}</td>
												<td></td>
												<td><a href="ModificationEtudList.php?cnie=${e.getCni()}">
														<button class="btn-primary fa fa-pencil-square"
															data-title="Edit" data-toggle="modal" data-target="#edit">
															<span class="glyphicon glyphicon-pencil"></span>
														</button>
												</a></td>
												<td><a
													href="supprimerEtudiantList.php?CNIE=${e.getCni()}">
														<button class="btn-danger fa fa-trash-o"
