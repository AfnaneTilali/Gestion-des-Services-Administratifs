					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-header">
								<strong class="card-title">All Profs</strong>
							</div>
							<div class="card-body">
								<div class="row" style="margin-left: 22em;">
									<div class="col-sm-12 col-md-6">
										<div class="dataTables_length">
											<a href="AjouterProf.php" type="button"
								...
								<div class="row" style="margin-left: 21em;">
								<div class="col-sm-12 col-md-6" >
										<div class="dataTables_length">
											<a href=".php" type="button"
												class="btn btn-outline-danger btn-sm"><i
												class="fa  fa-cloud-download"></i>&nbsp; Telecharger la liste</a>
										</div>
									</div>
								</div>
								<table id="bootstrap-data-table-export"
									...
									<tbody>
										<c:forEach items="${Mprof.getListProf()}" var="pr">


											<tr>
												<td>${pr.getNomPr()}</td>
												<td>${pr.getPrenomPr()}</td>
												<td>${pr.getCniPr()}</td>
												<td>${pr.getEmailPr()}</td>
												<td>${pr.getPhonePr()}</td>

												<td><a href="modifProfList.php?CNIPr=${pr.getCniPr()}">
												...
												<td><a
													href="supprimerProfList.php?CNIPr=${pr.getCniPr()}">
