								...
								<div class="row" style="margin-left: 26em;">
									<div class="col-sm-12 col-md-6">
										<div class="dataTables_length">
											<a href="AjouterModule.php" type="button"
								...
								<table id="bootstrap-data-table-export"
									...
									<thead>
										<tr>
											...
											<th>Nom Filiere</th>
											<th>Num Semestre</th>
											<th>Nbr d'heure de presence</th>
											<th>Edit</th>
											<th>Delete</th>
										</tr>
									</thead>
									<tbody>
										<c:forEach items="${Mother.getListModule()}" var="M">
											<tr>
												<td>${M.getNomM()}</td>
												<td>${M.getSeuille()}</td>
												<td>${M.getNomF()}</td>
												...
												<td>${M.getNbrPres()}</td>
												<td><a
													href="modifModuleList.php?NomM=${M.getNomM()}&NomF=${M.getNomF()}">
												...
												<td><a
													href="supprimerModuleList.php?NomM=${M.getNomM()}&NomF=${M.getNomF()}">
