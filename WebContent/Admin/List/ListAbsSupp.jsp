			...
			<div class="col-sm-4">
				<div class="page-header float-left">
					<div class="page-title">
						<h1>Absences Supprime des Etudiants</h1>
					</div>
				</div>
			</div>
			<div class="col-sm-8">
				<div class="page-header float-right">
					<div class="page-title">
						<ol class="breadcrumb text-right">
							...
							<li class="active">Absences Supprime des Etudiants</li>
						</ol>
					</div>
				</div>
			</div>
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<table id="bootstrap-data-table-export"
									...
									<tbody>
										<c:forEach items="${Mabs.getListAbsSupp()}" var="Abs">
											<tr>
												<td>${Abs.getDateAbsSupp()}</td>
												<td>${Abs.getNomM()}</td>
												<td>${Abs.getCniE()}</td>
												<td>${Abs.getCniPr()}</td>
												<td>${Abs.getNomM()}</td>
