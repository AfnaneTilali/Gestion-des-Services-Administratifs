                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <br>
                            <div class="container">
                                <form method="POST" action="ListEtudiantParAll.php">
                    
                                <div class="row">
                                    <div class="col-md-6 col-lg-4">
                                        <div class="single_works wow " data-wow-duration="1s"
                                            data-wow-delay=".4s">
                                            <h3 style="font-family: algerian, 'times new roman'; margin-left: 0em; color: #03506e;">Filiere</h3>
                                            <br>
                                            <div>
                                                <select class="form-control" name="FiliereE">
                                    ...
                                    <div class="col-md-6 col-lg-4" >
                                        <div class="single_works wow " data-wow-duration="1s"
                                            data-wow-delay=".5s">
                                            <h3
                                                style="font-family: algerian, 'times new roman'; margin-left: 0em; color: #03506e;">Semestre</h3>
                                    ...
                                    <div class="col-md-6 col-lg-4" >
                                        <div class="single_works wow " data-wow-duration="1s"
                                            ...
                                            <h3
                                                style="font-family: algerian, 'times new roman'; margin-left: 0em; color: #03506e;">Nbr d'Abs</h3>
                                            </br>
                                            <div>
                                                <input class="form-control" type="text" name="NbrAbs"
                                                    placeholder="Nombre d'absence" style="text-align: center;">
                                            </div>
                                    ...
                                    <div class="col-md-6 col-lg-4" >
                                        <div class="single_works wow " data-wow-duration="1s"
                                            data-wow-delay=".5s">
                                            <h3
                                                style="font-family: algerian, 'times new roman'; margin-left: 0em; color: #03506e;">Annee Univ</h3>
                    
                                            </br>
                                            <div>
                                                <select class="form-control" name="AnnUniv" >
                                                    <option value="" selected hidden>Annee Univ</option>
                                    ...
                                    data-wow-delay=".6s">
                                        <button style="margin-left: 28em;" type="submit">Get</button>
