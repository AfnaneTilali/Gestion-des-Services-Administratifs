					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-header">
								<strong class="card-title">All Parents</strong>
							</div>
							<div class="card-body">
							<div class="row" style="margin-left: 22em;">
								<div class="col-sm-12 col-md-6" >
										<div class="dataTables_length">
											<a href="UpListParent.php" type="button"
								...
								<table id="bootstrap-data-table-export"
									...
									<tbody>
										<c:forEach items="${Mparent.getListParent()}" var="p">
											...
											<tr>
												...
												<td><a href="modifParentList.php?CNIP=${p.getCniP()}">
												...
												<td><a
													href="supprimerParentList.php?CNIP=${p.getCniP()}">
