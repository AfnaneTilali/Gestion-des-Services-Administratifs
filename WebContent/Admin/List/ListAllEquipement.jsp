					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-header">
								<strong class="card-title">All Equipements</strong>
							</div>
							<div class="card-body">
								<div class="row" style="margin-left: 26em;">
									<div class="col-sm-12 col-md-6">
										<div class="dataTables_length">
											<a href="AjouterEquipement.php" type="button"
								...
								<table id="bootstrap-data-table-export"
									...
									<tbody>
										<c:forEach items="${Mother.getListEquipement()}" var="equ">
											<tr>
												<td>${equ.getNumEq()}</td>
												<td>${equ.getNomEq()}</td>
												<td>${equ.getNumS()}</td>
												<td><a
													href="modifEquipementList.php?IdEquipement=${equ.getIdEq()}">
												...
												<td><a
													href="supprimerEquipementList.php?IdEquipement=${equ.getIdEq()}">
