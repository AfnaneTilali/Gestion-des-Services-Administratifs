					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-header">
								<strong class="card-title">All Filieres</strong>
							</div>
							<div class="card-body">
								<div class="row" style="margin-left: 26em;">
									<div class="col-sm-12 col-md-6">
										<div class="dataTables_length">
											<a href="AjouterFil.php" type="button"
									...
									<tbody>
										<c:forEach items="${Mother.getListfili()}" var="fil">
											...
											<tr>
												<td>${fil.getNomF()}</td>
												<td>${fil.getChef()}</td>
												<td>${fil.getNbrSemestre()}</td>
												<td>${fil.getNbrModules()}</td>

												<td><a href="modifFiliereList.php?NomF=${fil.getNomF()}">
												...
												<td><a
													href="supprimerFiliereList.php?NomF=${fil.getNomF()}">
