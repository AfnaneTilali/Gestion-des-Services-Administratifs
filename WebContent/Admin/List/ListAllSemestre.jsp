					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-header">
								<strong class="card-title">All Semestres</strong>
							</div>
							<div class="card-body">
								<div class="row" style="margin-left: 26em;">
									<div class="col-sm-12 col-md-6">
										<div class="dataTables_length">
											<a href="AjouterSemestre.php" type="button"
								...
								<table id="bootstrap-data-table-export"
									...
									<tbody>
										<c:forEach items="${Mother.getListSemestre()}" var="S">
											<tr>
												<td>${S.getNumS()}</td>
												<td>${S.getNomF()}</td>
												<td>${S.getNbrModule()}</td>
												<td><a href="modifSemestreList.php?NumS=${S.getNumS()}&NomF=${S.getNomF()}">
												...
												<td><a
													href="supprimerSemestreList.php?NumS=${S.getNumS()}&NomF=${S.getNomF()}">
