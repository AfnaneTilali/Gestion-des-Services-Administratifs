				...
				<div class="page-header float-right">
					<div class="page-title">
						<ol class="breadcrumb text-right">
							...
							<li class="active">Presence des Profs</li>
						</ol>
					</div>
				</div>
			</div>
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-header">
								<strong class="card-title">All Presences des Profs</strong>
							</div>
							<div class="card-body">
								...
								<table id="bootstrap-data-table-export"
									...
									<tbody>
										<c:forEach items="${Mother.getListPresProf()}" var="pres">
											<tr>
												<td>${pres.getDatePres()}</td>
												<td>${pres.getNomM()}</td>
												<td>${pres.getCniPr()}</td>
												<td>${pres.getNomF()}</td>
												<td>${pres.getNumS()}</td>
												<td><c:if test="${pres.isCren1()}">08:30-10:30</c:if>
												<c:if test="${pres.isCren2()}">10:45-12:45</c:if>
												<c:if test="${pres.isCren3()}">14:30-16:30</c:if>
												<c:if test="${pres.isCren4()}">16:45-18:45</c:if>
												</td>
											</tr>
										</c:forEach>
									</tbody>
