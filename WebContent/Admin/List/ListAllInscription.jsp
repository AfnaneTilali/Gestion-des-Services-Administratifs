					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-header">
								<strong class="card-title">All Inscriptions</strong>
							</div>
							<div class="card-body">
								<div class="row" style="margin-left: 26em;">
									<div class="col-sm-12 col-md-6">
										<div class="dataTables_length">
											<a href="AjouterInscription.php" type="button"
								...
								<table id="bootstrap-data-table-export"
									...
									<tbody>
										<c:forEach items="${Mother.getListInsc()}" var="Insc">


											<tr>
												<td>${Insc.getDateInscrtiption()}</td>
												<td>${Insc.getCniE()}</td>
												<td>${Insc.getNomF()}</td>
												<td>${Insc.getNumS()}</td>

												<td><a href="modifInscriptionList.php?IdInsc=${Insc.getIdInscription()}">
												...
												<td><a
													href="supprimerInscriptionList.php?IdInsc=${Insc.getIdInscription()}">
