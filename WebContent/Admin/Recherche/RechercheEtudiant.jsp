				...
				<div class="page-header float-right">
					<div class="page-title">
						<ol class="breadcrumb text-right">
							...
							<li class="active">Recherche d'un Etudiant</li>
						</ol>
					</div>
				</div>
			</div>
		</div>
		<form method="POST" action="SearchEtudiant.php">
							...
							<div class="card">
								...
								<div class="card-body">
									<div class="card-body card-block">
										<div style="margin-left: 16em; width: 22em;"
											class="single_works wow fadeInUp" data-wow-duration="1s"
											data-wow-delay=".6s">
											<h5 style="text-align: center; color: #0099d4;">Recherche
												d'etudiant</h5>
											<br>
											<div>
												<input class="form-control" type="text" name="CNIE"
													placeholder="CNI" style="text-align: center;">
											</div>
											<br>
											<button>Get</button>
