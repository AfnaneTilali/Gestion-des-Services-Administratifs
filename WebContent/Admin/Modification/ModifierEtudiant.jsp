			...
			<div id="main-menu" class="main-menu collapse navbar-collapse">
				<ul class="nav navbar-nav">
					...
					<li class="menu-item-has-children dropdown"><a href="#"
						...
						<ul class="sub-menu children dropdown-menu">
							<li><i class="fa fa-plus-square"></i><a
								href="GetFiliereSemestre.php">D'une classe</a></li>
							<li><i class="fa fa-plus-square-o"></i><a
								href="GetFiliereSemestreEtud.php">D'un Etudiant</a></li>
					...
					<li class="menu-item-has-children dropdown"><a href="#"
						...
						<ul class="sub-menu children dropdown-menu">
							<li><i class="fa fa-plus-square-o"></i><a
								href="AjouterReservation.php">Ajout</a></li>
							<li><i class="fa ti-search"></i><a
								href="RechercheReservation.php">Recherche</a></li>
							<li><i class="fa ti-list-ol"></i><a
								href="ListAllReservation.php">List</a></li>
						</ul></li>
					...
					<li class="menu-item-has-children dropdown"><a href="#"
						...
						<ul class="sub-menu children dropdown-menu">
							<li><i class="fa ti-layout-list-thumb"></i><a
								href="ListAllAbs.php">All Abs</a></li>
							<li><i class="fa ti-layout-menu-v"></i><a
								href="ListAbsSupp.php">Abs Supprimee </a></li>
							<li><i class="fa fa-calendar"></i><a href="AbsCal.php">Abs
									Par Calendrier </a></li>
							<li><i class="fa fa-calendar"></i><a href="AbsSuppCal.php">Abs
									Supp Par Calendrier </a></li>
						</ul></li>
					...
					<li class="menu-item-has-children dropdown"><a href="#"
						...
						<ul class="sub-menu children dropdown-menu">
							...
							<li><i class="fa ti-layout-list-thumb"></i><a href="">
									..... </a></li>
					...
					<li class="menu-item-has-children dropdown"><a href="#"
						...
						<ul class="sub-menu children dropdown-menu">
							...
							<li><i class="fa fa-list-alt"></i><a
								href="ListAllSemestre.php">Semestre</a></li>
							<li><i class="fa ti-menu-alt"></i><a
								href="ListAllModule.php">Modules</a></li>
							<li><i class="fa fa-users"></i><a href="ListAllProf.php">Profs</a></li>
							<li><i class="fa fa-file-text-o"></i><a
								href="ListAllInscription.php">Inscriptions</a></li>
							<li><i class="fa fa-building-o"></i><a
								href="ListAllSalle.php">Salles</a></li>
							<li><i class="fa fa-filter"></i><a
								href="ListAllEquipement.php">Equipement</a></li>
							<li><i class="fa fa-calendar"></i><a
								href="ListAllPresProf.php">Presence Prof</a></li>
						</ul></li>
				</ul>
			</div>
			<!-- /.navbar-collapse -->
				...
				<div class="page-header float-right">
					<div class="page-title">
						<ol class="breadcrumb text-right">
							...
							<li class="active">Modifier Etudiant</li>
						</ol>
					</div>
				</div>
			</div>
		</div>
		<form method="POST" action="updateE.php" enctype="multipart/form-data">
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<strong class="card-title">Modifier un etudiant</strong>
								</div>
								<div class="card-body">
									<div class="card-body card-block">
										<!-- <div class="form-group">
											<div class="form-group last" style="margin-left: 0em;">
												<h4 style="margin-left: 1em;">Image Upload</h4>
												<br>
												<div class="col-md-9">
													<div class="fileupload fileupload-new"
														...
														<div>
															<span class="btn btn-theme02 btn-file"> <span
																...
																class="default" name="photo" required />
										...
										<div class="form-group">
											<div class="input-group">
												...
												<input class="form-control" type="text" name="Nom"
													value="${MEtudiant.getEtudiant().getNom()} " required>
											</div>
											<small class="form-text text-muted">ex. Einstein</small>
										</div>
										<div class="form-group">
											<div class="input-group">
												<div class="input-group-addon">
												...
												<input class="form-control" type="text" name="Prenom"
													value="${MEtudiant.getEtudiant().getPrenom()}" required>
											</div>
											<small class="form-text text-muted">ex. Albert</small>
										</div>
										...
										<div class="form-group">
											...
											<small class="form-text text-muted">ex. D123456</small>
										</div>
										<div class="form-group">
											<div class="input-group">
												<div class="input-group-addon">
												...
												<input class="form-control" type="text" name="CIN"
													value="${MEtudiant.getEtudiant().getCin()}" required>
											</div>
											<small class="form-text text-muted">ex. M123456</small>
										</div>
										<div class="form-group">
											<div class="input-group">
												<div class="input-group-addon">
												...
												<input class="form-control" type="email" name="Email"
													value="${MEtudiant.getEtudiant().getEmail()}" required>
											</div>
											<small class="form-text text-muted">ex. abc@xy.z</small>
										</div>
										<div class="form-group">
											<div class="input-group">
												<div class="input-group-addon">
												...
												<input class="form-control" type="number" name="Phone"
													value="${MEtudiant.getEtudiant().getPhone()}" required>
											</div>
											<small class="form-text text-muted">ex. (999)
												999-9999</small>
										</div>
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input class="form-control" type="date"
													value="${MEtudiant.getEtudiant().getDateN()}" name="DateN"
													required>
											</div>
										...
										<div class="form-group">
											<div class="input-group">
												...
												<input class="form-control" type="text" name="Adresse"
													value="${MEtudiant.getEtudiant().getAdresse()}" required>
											</div>
											<small class="form-text text-muted">ex. NR 8754,
												Marjan, Meknes</small>
										</div>
										<div class="form-group">
											<div class="input-group">
												...
												<input class="form-control" type="text"
													value="${MEtudiant.getEtudiant().getVilleN()}"
													name="VilleN" required>
											</div>
											<small class="form-text text-muted">ex. Meknes</small>
										</div>
										...
										<div class="form-group">
											<div class="input-group">
												...
												<select class="form-control" name="Sexe" required>
													<option selected>${MEtudiant.getEtudiant().getSexe()}</option>
													<option>Femme</option>
													<option>Homme</option>
												</select> <span class="select-arrow"></span>
											</div>
											<small class="form-text text-muted">ex. Female</small>
										</div>
										<div class="form-group">
											<div class="input-group">
												<div class="input-group-addon">
												...
												<select class="form-control" name="Filiere" required>
													<option value="" selected>${MEtudiant.getEtudiant().getFiliere()}</option>
													<c:forEach items="${Mother.getListfili()}" var="etudiant">

														<option>${etudiant.getNomF()}</option>
										...
										<div class="form-group">
											...
											<div class="input-group">
												...
												<select class="form-control" name="AnneeUniv" required>
													<option value="" selected>${MEtudiant.getEtudiant().getAnneeUniv()}</option>
											...
											<small class="form-text text-muted">ex. 2019-2020</small>
										</div>
										<div class="form-group">
											...
											<div class="input-group">
												...
												<select class="form-control" name="Country" required>
													<option value="" selected>${MEtudiant.getEtudiant().getCountry()}</option>
											...
											<small class="form-text text-muted">ex. Morocco</small>
										</div>
									</div>
									...
									<div>
										...
										<a href="ListAllEtudiant.php" type="reset"
											class="btn btn-danger btn-sm"> <i class="fa fa-ban"></i>
											Reset
										</a>
									</div>
								</div>
