				...
				<div class="page-header float-right">
					<div class="page-title">
						<ol class="breadcrumb text-right">
							...
							<li class="active">Modifier Parent</li>
						</ol>
					</div>
				</div>
			</div>
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<strong class="card-title">Modifier un parent</strong>
								</div>
								<div class="card-body">
									<div class="card-body card-block">
										<div class="form-group">
											<div class="input-group">
												...
												<input class="form-control" type="text" name = "NomP" value="${Mparent.getParent().getNomP()}"  required> 
											</div>
										...
										<div class="form-group">
											<div class="input-group">
												...
												<input class="form-control" type="text" name = "PrenomP" value="${Mparent.getParent().getPrenomP()}"
											required> 
											</div>
										...
										<div class="form-group">
											<div class="input-group">
												...
												<input class="form-control" type="number" name = "Phone" value="${Mparent.getParent().getPhone()}"
											required> 
											</div>
										...
										<div class="form-group">
											<div class="input-group">
												...
												<input class="form-control" type="text" name = "CNIP" value="${Mparent.getParent().getCniP()}" desabled> 
											</div>
										...
										<div class="form-group">
											<div class="input-group">
												...
												<input class="form-control" type="email" name = "EmailP" value="${Mparent.getParent().getEmailP()}"
											required> 
											</div>
										...
										<a href="ListAllEtudiant.php" type="reset" class="btn btn-danger btn-sm"> <i
