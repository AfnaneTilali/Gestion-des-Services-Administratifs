				...
				<div class="page-header float-right">
					<div class="page-title">
						<ol class="breadcrumb text-right">
							...
							<li class="active">All Etudiant</li>
						</ol>
					</div>
				</div>
			</div>
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-header">
								<strong class="card-title">All Etudiants</strong>
							</div>
							<div class="container">

								<form method="POST" action="AddAbs.php">
									<br> <input type="hidden" name="filiere"
										value="${MEtudiant.getFiliere()}" /> <input type="hidden"
										name="semestre" value="${MEtudiant.getNumS()}" />
									<div class="row">
										<div class="col-md-6 col-lg-4">
											<div class="single_works wow " data-wow-duration="1s"
												data-wow-delay=".4s">
												<h3
													style="font-family: algerian, 'times new roman'; margin-left: 0em; color: #03506e;">Profs</h3>
												<br>
												<div>
													<select class="form-control" name="Profs">
														<option value="" selected hidden>Profs</option>
														<c:forEach items="${Mprof.getListProf()}" var="prof">
															<option>${prof.getNomPr()}</option>
														</c:forEach>
										...
										<div class="col-md-6 col-lg-4">
											<div class="single_works wow " data-wow-duration="1s"
												data-wow-delay=".5s">
												<h3
													style="font-family: algerian, 'times new roman'; margin-left: 0em; color: #03506e;">Modules</h3>
												</br>
												<div>
													<select class="form-control" name="Module">
														<option value="" selected hidden>Modules</option>
														<c:forEach items="${Mother.getListModule()}" var="Module">
															<option>${Module.getNomM()}</option>
														</c:forEach>
													</select> <span class="select-arrow"></span>
												</div>
												</br>
										...
										<div class="col-md-6 col-lg-4">
											<div class="single_works wow " data-wow-duration="1s"
												data-wow-delay=".5s">
												<h3
													style="font-family: algerian, 'times new roman'; margin-left: 0em; color: #03506e;">creneau</h3>
												</br>
												<div>
													<select class="form-control" name="creneau">
														<option value="" selected hidden>creneau</option>
														<option value="1">08:30 - 10:30</option>
														<option value="2">10:45 - 12:45</option>
														<option value="3">14:30 - 16:30</option>
														<option value="4">16:45 - 18:45</option>
													</select> <span class="select-arrow"></span>
												</div>
												</br>
											</div>
										...
										<div class="col-md-6 col-lg-4">
											<div class="single_works wow " data-wow-duration="1s"
												data-wow-delay=".5s">
												<h3
													style="font-family: algerian, 'times new roman'; margin-left: 0em; color: #03506e;">Date</h3>
												</br>
												<div>
													<div>
														<input class="form-control" type="date" name="DateAbs"
															required>
													</div>
												</div>
											</div>
									...
									<div class="card-body">
										<table class="table table-striped table-bordered" cellspacing="0" width="100%">
											...
											<tbody>
												<c:forEach items="${MEtudiant.listEtud}" var="e">
													<input type="hidden" name="NomE" value="${e.getNom()}" />
													<input type="hidden" name="PrenomE"
														value="${e.getPrenom()}" />
													<input type="hidden" name="CniE" value="${e.getCni()}" />
													<input type="hidden" name="DateN" value="${e.getDateN()}" />
													<input type="hidden" name="seanceInput" />
													<tr>
														<td>${e.getNom()}</td>
														<td>${e.getPrenom()}</td>
														<td>${e.getCni()}</td>
														<td>${e.getDateN()}</td>
														<td><select class="form-control" name="absence">
									...
									<div class="single_works wow fadeInUp" data-wow-duration=""
													data-wow-delay=".6s">
													<button style="margin-left: 28em;" type="submit">Add</button>
