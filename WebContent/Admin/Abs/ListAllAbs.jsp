				...
				<div class="page-header float-right">
					<div class="page-title">
						<ol class="breadcrumb text-right">
							...
							<li class="active">Absences des Etudiants</li>
						</ol>
					</div>
				</div>
			</div>
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-header">
								<strong class="card-title">Absences des Etudiants</strong>
							</div>
							<div class="card-body">
								...
								<table id="bootstrap-data-table-export"
									...
									<tbody>
										<c:forEach items="${Mabs.getListAbs()}" var="Abs">
											<tr>
												<td>${Abs.getDateAbs()}</td>
												<td>${Abs.getNomM()}</td>
												<td>${Abs.getCniE()}</td>
												<td>${Abs.getCniPr()}</td>
												<td>${Abs.getNomM()}</td>
												<td><c:if test="${Abs.isCren1()}">08:30-10:30</c:if> <c:if
														test="${Abs.isCren2()}">10:45-12:45</c:if> <c:if
														test="${Abs.isCren3()}">14:30-16:30</c:if> <c:if
														test="${Abs.isCren4()}">16:45-18:45</c:if></td>
												<td><a
													href="modifAbsList.php?IdAbs=${Abs.getIdAbs()}">
												...
												<td><a
													href="supprimerAbsList.php?IdAbs=${Abs.getIdAbs()}">
