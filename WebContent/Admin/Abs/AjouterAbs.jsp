				...
				<div class="page-header float-right">
					<div class="page-title">
						<ol class="breadcrumb text-right">
							<li class="active">List Etudiants</li>
						</ol>
					</div>
				</div>
			</div>
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<strong class="card-title">Info List</strong>
								</div>
								<br>
								<div class="container">
									<form method="POST" action="AddAbsEtud.php" enctype="multipart/form-data">
										...
										<div class="row">
											...
											<div class="col-md-6 col-lg-4">
												<div class="single_works wow " data-wow-duration="1s"
													...
													<h3
														style="font-family: algerian, 'times new roman'; margin-left: 0em; color: #03506e;">CNI
														Etudiant</h3>
													</br>
													<div>
														<input class="form-control" type="text" name="CNIE"
															placeholder="CNI Etudiant" style="text-align: center;">
													</div>
													</br>
												</div>
											</div>
											...
											<div class="col-md-6 col-lg-4">
												<h3 style="font-family: algerian, 'times new roman'; margin-left: 1em; color: #03506e;">Justification</h3>
												<br>
														...
														<div class="input-group">
															<span class="btn btn-theme02 btn-file"> <span
																class="fileupload-new"><i class="fa fa-paperclip"></i>
																	Select file</span> <input type="file" class="default"
																name="file" required />
															</span>
														</div>
													</div>
											...
											<div class="single_works wow fadeInUp" data-wow-duration=""
												data-wow-delay=".6s">
												<button style="margin-left: 26em;" type="submit">Get</button>
											</div>
											<br>
										</div>
									</form>
