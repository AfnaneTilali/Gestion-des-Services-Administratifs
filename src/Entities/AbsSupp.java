...
public class AbsSupp {
	private int idAbsSupp ;
	private Date dateAbsSupp ;
	//private String Time ;
	...
	public int getIdAbsSupp() {
		return idAbsSupp;
	}
	public void setIdAbsSupp(int idAbsSupp) {
		this.idAbsSupp = idAbsSupp;
	}
	public Date getDateAbsSupp() {
		return dateAbsSupp;
	}
	public void setDateAbsSupp(Date dateAbsSupp) {
		this.dateAbsSupp = dateAbsSupp;
	}
	...
	public String toString() {
		return "AbsSupp [idAbsSupp=" + idAbsSupp + ", dateAbsSupp=" + dateAbsSupp + ", cren1=" + cren1 + ", cren2="
				+ cren2 + ", cren3=" + cren3 + ", cren4=" + cren4 + ", cniE=" + cniE + ", nomM=" + nomM + ", cniPr="
				+ cniPr + ", nomF=" + nomF + ", numS=" + numS + ", bytes=" + Arrays.toString(bytes) + "]";
	}
